...
import view.meber.MemberFrame;
import dao.*;

public class MainFrame extends JFrame {
    private Membership.src.view.jenismember.JenisMemberFrame jenisMemberFrame;
    private Membership.src.view.member.MemberFrame memberFrame;
